@php
    ...
    $itemTag = $menuOptions['item_tag'] ?? 'li';
    $linkTag = $menuOptions['link_tag'] ?? 'a';
    $childrenTag = $menuOptions['children_tag'] ?? 'ul';
    ...
    $itemClasses = trim(implode(' ', array_filter([
        $menuOptions['item_class'] ?? 'site-nav__item',
    ...
    $linkClasses = trim(implode(' ', array_filter([
        $menuOptions['link_class'] ?? 'site-nav__link',
    ...
    $childrenClasses = trim(implode(' ', array_filter([
        $menuOptions['children_class'] ?? 'site-nav__children',
