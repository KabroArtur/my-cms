    ...
    <div class="custom-rich-text-field">
        <div class="admin-editor-toolbar compact">
            <div class="tiptap-toolbar-group">
                <AdminButton
                    :class="buttonClass(toolbar.bold)"
                    type="button"
                    @click="editor?.chain().focus().toggleBold().run()"
                    >B</AdminButton
                >
                <AdminButton
                    :class="buttonClass(toolbar.italic)"
                    type="button"
                    @click="editor?.chain().focus().toggleItalic().run()"
                    >I</AdminButton
                >
                <AdminButton
                    :class="buttonClass(toolbar.underline)"
                    type="button"
                    @click="editor?.chain().focus().toggleUnderline().run()"
                    >U</AdminButton
                >
                <AdminButton
                    :class="buttonClass(toolbar.link)"
                    type="button"
                    @click="editLink"
                    >Link</AdminButton
                >
            ...
            <div class="tiptap-toolbar-group">
                <AdminButton
                    :class="buttonClass(toolbar.bulletList)"
                    type="button"
                    @click="editor?.chain().focus().toggleBulletList().run()"
                    >• List</AdminButton
                >
                <AdminButton
                    :class="buttonClass(toolbar.orderedList)"
                    type="button"
                    @click="editor?.chain().focus().toggleOrderedList().run()"
                    >1. List</AdminButton
                >
                <AdminButton
                    :class="buttonClass(toolbar.blockquote)"
                    type="button"
