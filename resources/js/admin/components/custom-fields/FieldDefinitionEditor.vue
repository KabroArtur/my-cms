...
<template>
    <section class="field-definition-editor">
        ...
        <div class="admin-form-stack mt-16">
            <article
            ...
            >
                <div
                    class="admin-actions-row field-definition-editor__card-header"
                >
                ...
                <div class="page-meta-grid">
                    ...
                    <label
                        class="admin-form-label key-settings"
                        data-label="Key:"
                    >
                        <input
                            :value="field.key"
                ...
                <div class="page-meta-grid">
                    ...
                    <label
                        ...
                        :class="{
                            'is-full': ['textarea', 'editor'].includes(
                                field.type,
                            ),
                        }"
                        :data-label="
                    ...
                    >
                        ...
                        <textarea
                            v-else-if="
                                ['textarea', 'editor'].includes(field.type)
                            "
                            :value="field.default_value"
                ...
                >
                    ...
                    <div
                        v-for="(option, optionIndex) in field.settings
                            ?.options || []"
