...
class StoreAdditionalFieldGroupRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'key' => ['required', 'string', 'max:255', 'regex:/^[a-z0-9_]+$/', 'unique:additional_field_groups,key'],
            ...
            'fields.*.key' => ['required', 'string', 'max:255', 'regex:/^[a-z0-9_]+$/', 'distinct', Rule::unique((new AdditionalField())->getTable(), 'key')],
